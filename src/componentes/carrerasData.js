...
const CardIngGestionEmpresarialLinea = 'http://tecmm.edu.mx/imagesReact/images/ofertaAcademicaNueva/Ing-Gestion-Empresarial-enLinea.jpg'
const RetIngGestionEmpresarialLinea = 'http://tecmm.edu.mx/reticulasCarreras/Reticula-Ingenieria-en-Gestion-Empresarial.pdf'
...
export default function CarrerasData(){
  ...
  var carrerasArray = [];
    ...
    carrerasArray[1]={
      ...
      objetivo: "Formar profesionales competentes en la creación, dirección e innovación de organizacionesque enfrenten desafíos en un entorno globalizado, con visión emprendedora, ética, humana y de responsabilidad social.",
      perfilEgreso : [
    ...
    {/*carrerasArray[2]={
      ...
      perfilEgreso : [
                      ...
                      {perfil:"Ser analítico, ético, crítico, y consiente de la constancia de su entorno para la vida y respetuoso de la misma, siendo promotor del desarrollo sustentable."},
    ...
    carrerasArray[7]={
      ...
      reticula: RetIngElectromecanica,
    ...
    {/*carrerasArray[13]={
      ...
      objetivo: "Formar profesionistas con bases sólidas científicas, tecnológicas, con actitudes éticas y aptitudes; capaces de dise��ar, administrar, desarrollar, controlar e innovar sistemas de producción en la industria alimentaria, orientados de manera sustentable e integral en el ámbito regional, nacional e internacional.",
      perfilEgreso : [
    ...
    carrerasArray[18]={
      ...
      perfilEgreso : [
                      {perfil:"Diseñar, implementar y administrar redes de cómputo y comunicaciones, bajo modelos y estándares internacionales, para satisfacer las necesidades de información de los sistemas sociales, garantizando aspectos de seguridad y calidad."},
                      {perfil:"Diseñar, desarrollar y mantener sistemas de bases de datos asegurando la integridad, disponibilidad y confidencialidad de la información almacenada."},
                      {perfil:"Integrar las diferentes arquitecturas de hardware y administrar plataformas de software para incrementar la productividad en las organizaciones."},
                      {perfil:"Implementar sistemas de seguridad bajo políticas internas de las organizaciones y estándares aceptados."},
                      {perfil:"Observar los aspectos legales del uso y explotación de las Tecnologías de la Información y Comunicaciones."},
                      {perfil:"Desarrollar e implementar sistemas de información para el control y la toma de decisiones utilizando metodologías basadas en estándares internacionales."},
                      {perfil:"Analizar, diseñar y programar dispositivos con software empotrado."},
                      {perfil:"Utilizar tecnologías y herramientas actuales y emergentes acordes a las necesidades del entorno."},
                      {perfil:"Integrar soluciones basadas en sistemas de comunicaciones que involucren tecnologías actuales y emergentes."},
                      {perfil:"Desempeñar funciones de consultoría y auditoría en el campo de las Tecnologías de la Información y Comunicaciones."},
                      {perfil:"Crear empresas en el ámbito de las Tecnologías de la Información y Comunicaciones."},
                      {perfil:"Administrar proyectos que involucren Tecnologías de la Información y Comunicaciones en las organizaciones conformea requerimientos establecidos."},
      ],
      reticula: RetIngTecnologiasdelaInformacionComunicaciones,
      ...
      folleto: FoIngTecnologiasdelaInformacionComunicaciones,
    };
    ...
    carrerasArray[22]={
      ...
      reticula: null,
      folleto: FoMaestriaAdministracion,
