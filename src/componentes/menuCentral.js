  ...
  render(){
    ...
    return(
      <div className="div-principalMenuCentral">
        ...
        <a href="/">
          <img className="img-menuCentral-header" src="http://tala.tecmm.edu.mx/imagenes/header.jpg"/>
        </a>
        <img className="img-menuCentral-nombre" src="http://tala.tecmm.edu.mx/imagenes/tala.png"/>
